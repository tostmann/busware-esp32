...
bool AVRConfig::SetDummy() {
    mConfig = {0};
    mConfig.fCPU = 8000000;
    mConfig.flashPageSize = 0x80;
    uint32_t value = 0x1e9516;
    mConfig.signature[0] = value >> 16;
    mConfig.signature[1] = value >> 8;
    mConfig.signature[2] = value;
    mConfig.chipEraseDelay     = 10500;
    mConfig.flashMinWriteDelay = 4500;
    return true;
};
...
#ifndef __MACH__
	File file = LittleFS.open(inPath);
	bool fileOpened = (file && !file.isDirectory());
	mFile = &file;    
#else
